...
# gets schedules for the 2020 season. It needs to account 
# for the fact that April data does not have playoff games yet.
...
sched_2020 <- function(year){
  ...
  months.all <- c("october", "november", "december", "january","february","march","april")
